...
- [x] T-58 서버 추천 API (2026-08-03 완료 — 실기기 검증): GET /api/v1/recommendations — 최근 7일 이내 가격 하락 상품, 하락폭 큰 순. 클라이언트 홈 모드 "추천 상품 — 최근 가격 하락" 섹션 (3개, 탭 시 브라우저 열기). 구매 추천가/가짜 할인 판정은 데이터 축적 후 확장
