...
## T-106~T-109 — 데이터 활용 고도화: 크로스몰 비교 + 타이밍 인사이트 (v0.13.0) — 🔵 서버 완료, 확장·검증 중 (2026-08-08)
...
- [x] **T-107** 서버: `ProductOut.alternatives`(동일상품 다른 몰 가격/워처/URL) + 찜 목록 `?include=alternatives`
...
- [ ] 문서: CHANGELOG v0.13.0 / ENDPOINTS.md / manifest 0.13.0
