...
> 재구성 v0.3.0 시작 (2026-08-03). 상태: 🔵 진행 / ✅ 완료 / ⏸ 보류 / ⛔ 종료

## ⛔ 프로젝트 종료 (2026-08-15)
> **사용자 결정: 프로젝트 접기.** 저장소는 읽기 전용 아카이브로 보존.
> 최종 정리: `docs/ARCHIVE.md` — 종료 사유, 시스템 구성, 재사용 가이드, 실측 교훈(크롤링 차단/가격 오탐 방어 설계).
> 미해결 이슈(T-127h 포함)는 모두 종료 처리하며, 재개 시 ARCHIVE.md 9장 체크리스트 참고.

## T-127 — 매니저 로컬 배치 실행기 + 인사이트 리스트/그리드 + AI 보류 (v0.16.16) — ⛔ 종료 (2026-08-15)
